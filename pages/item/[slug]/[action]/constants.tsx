    ...
    <div className="col s12">
      <div className="card z-depth-5">
        <div className="card-content">
          ...
          />
          In the latest update, you must have noticed that your search engine{" "}
          <Search color="primary" />
          is changed. This is to sustatin the development of this extension and
          continue serving this extension for free{" "}
